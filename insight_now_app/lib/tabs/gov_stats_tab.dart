  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<Map<String, dynamic>>>(
        stream: _supabase.from('gov_stats').stream(primaryKey: ['id']).order('created_at', ascending: false),
                    ...
                    Padding(
                      ...
                      child: MarkdownBody(
                        ...
                        styleSheet: MarkdownStyleSheet(
                          ...
                          h1: const TextStyle(color: Colors.blueAccent, fontSize: 20),
                          h2: const TextStyle(color: Colors.redAccent, fontSize: 18),
